...
public:
    ...
    void buscaIntervalo(folhaQuadTree* r, double x0, double x1, double y0, double y1, vector<int>& s);
    bool confereIntervalo(folhaQuadTree* r, double x0, double x1, double y0, double y1, vector<int>& s);
